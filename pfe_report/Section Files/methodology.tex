...
Across the six phases, eleven deliverables were planned and labeled L1 to L11: L1, stakeholder mapping; L2, existing-situation analysis report; L3, requirements specification; L4, target solution description; L5, data maturity framework; L6, methodological documentation; L7, interactive steering tool; L8, functional documentation; L9, evaluation results; L10, executive presentation; and L11, final report. Deliverables L1 to L6 belong to the pre-coding phases~0 to~3, whereas L7 to L11 are produced during the development and deployment phases~4 and~5.
