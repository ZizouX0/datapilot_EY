...
The design of the framework is grounded in two categories of research materials, both gathered during the pre-coding phases. The first is the diagnostic survey of 44 banking professionals, conducted as part of the Phase~1 analysis of the existing situation, which provides the field evidence on the current state of data governance, quality, architecture, analytics, and culture in the sector, and which informs both the diagnosis and the design of the framework. The second is a benchmark that screened fifteen international data maturity frameworks and retained five, DAMA-DMBOK, DCAM, CMMI-DMM, TDWI, and Gartner, whose comparative analysis, presented in the previous chapter, determines the role retained from each in the hybrid model.
