...
In the figure, the five columns correspond to the assessment's five dimensions (D1--D5). The numbers shown, 25/20/20/20/15\%, are the dimension weights, the share each contributes to the overall maturity score. Figure~\ref{fig:hybrid-mapping} summarizes the role each benchmark contributes to the hybrid framework.
