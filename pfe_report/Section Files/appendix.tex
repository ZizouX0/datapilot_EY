...
\noindent \textit{All indicators in D5 are proxy indicators. They rely on proxy evidence that is largely objective and auditable (headcount ratios, certification counts, budget lines, and program documentation), but some D5.2 rubrics also involve qualitative judgments of culture and engagement (for example, whether the business drives the data agenda). These judgments are proxies for the culture itself rather than direct measurements of it.}
