...
\vspace{0.5em}
\noindent \textbf{Regulatory compliance.} A regulatory indicator is compliant when its effective score reaches 3, non-compliant below 3, and pending when unanswered. The compliance rate is the share of the thirteen regulatory indicators that are compliant. The regulatory exposure is Low when the rate reaches 80\%, Medium when it reaches 50\%, and High otherwise.
